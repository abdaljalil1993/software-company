...
<div style="background-image: url('images/r.jpg');background-repeat: no-repeat;background-size: cover;background-attachment: fixed; height: 600px; ">
<div style="background-color:rgba(10,54,108,0.5);width: 100%;height: 600px;">
	<div class="mynav">
  ...
  <div class="collapse navbar-collapse" id="navbarText">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item x">
        <a class="nav-link a" style="color: #E7E7E8; font-size: 17px;" href="index.php#pro">Country</a>
      </li>
        <li class="nav-item x">
...
<div class="row">
	...
	<div class="col-md-8">
	  <div class="text-center" >
       <img alt="citizenships logo" src="images/logo.png" style="width: 300px;height: 300px;">
       <br>
        <p style="color:#E7E7E8;font-weight: bold; ">Our business is helping our clients gain a second passport and become citizens of the world. Our services include taking care of all the details you need to take advantage of citizenship by investment, residency programs, legal services, and more.</p>
        <br>
        <br>
        <br>
      </div>
