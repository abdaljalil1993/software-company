  ...
  <div class="collapse navbar-collapse" id="navbarText">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item x">
        ...
        <li class="nav-item x">
        <a class="nav-link a active" style="color: #E7E7E8; font-size: 17px;" href="mp.php">Manage Blogs</a>
      </li>
        <li class="nav-item x">
...
<div class="text-center" style="margin: 50px auto;">
  <h1 class="text-warning">Manage Posts </h1>
...
<div class="container" >
  <div class="row">
    ...
    <h1 class="text-warning">All Posts</h1> 
    <hr>
  ...
  <tbody>
    ...
    include'conn.php';
    $t=mysqli_query($con,"select * from posts");
...
<td>'.$row['title'].'</td>
<td>'.$row['post'].'</td>
<td><img src="uploads/'.$row['image'].'" style="width:100px;height:100px;"></td>
<td>'.$row['dt'].'</td>

<td><a href="mp.php?id='.$row['id'].'" class="btn btn-danger">Delete</a></td>
<td><a href="mp.php?id='.$row['id'].'" class="btn btn-primary">Update</a></td>
</tr>
  ';
}
  ...
  if(isset($_GET['id']))
    {
      ...
      $t=mysqli_query($con,"delete from posts where id='$x'");
      if(isset($t)){
