...
<div class="text-center" style="margin: 50px auto;">
  <h1 class="text-warning">Manage Messages </h1>
...
<div class="container" >
  <div class="row">
    ...
    <h1 class="text-warning">All  Messages</h1> 
    <hr>
  ...
  <tbody>
    ...
    include'conn.php';
    $t=mysqli_query($con,"select * from msg");
...
<td><a href="mm.php?id='.$row['id'].'" class="btn btn-danger">Delete</a></td>
<td><a href="editsmg.php?id='.$row['id'].'" class="btn btn-primary">Update </a></td>
</tr>
  ';
}
  ...
  if(isset($_GET['id']))
    {
      ...
      $t=mysqli_query($con,"delete from msg where id='$x'");
      if(isset($t)){
        echo '<script type="text/javascript">toastr.success("delete Message Successfully");</script>';
       echo' <meta http-equiv="refresh" content="0 ;url=mm.php" />';
      }
    }
