...
<div class="container-fluid top-bar" >
		<span style="margin-left: 25px"> <i style="color:#D69B25;font-size: 21px; " class=" fab fa-whatsapp"></i> +964 751 786 3790</span>
...
<div style="background-color:rgba(10,54,108,0.2);width: 100%;height: 300px; ">
  ...
  <a  class="navbar-brand" href="#" style="color: #E7E7E8; font-size: 20px;"> <img id="logo" src="images/logo1.png" alt="citizenships logo" style="width: 160px;height: 100px;"> Maali Al Khir</a>
...
<div style="background-color: #fff;width: 100%;padding: 20px;">
	...
	<?php
	include'conn.php';
	$t=mysqli_query($con,"select * from posts order by dt desc");
	...
	<div class="card-header" style="background-color: #a0a0a0;"><h1 class="text-white">'.$row['title'].'</h1></div>
		...
		<img src="uploads/'.$row['image'].'" style="width:100%;height:340px;">
		<p>'.substr($row['post'],0,100).'....</p>

		<p style="color:blue;">'.$row['dt'].'</p>

		<a href="read.php?id='.$row['id'].'" class="btn btn-primary">read more</a>
  ...
  <li><i class="fa fa-angle-double-right text-warning"></i>
	...
	<li style="color: white;"><i class="fa fa-angle-double-right text-warning"></i>Saint Kitts and Nevis</li>
    			...
    			<div class="col-md-3 col-sm-12" style="height: 240px;">
    				...
    				<span style="color: white"> <i style="color:#D69B25;font-size: 20px; " class=" fa fa-phone"></i> +964 751 786 3790</span><br>
    				<br>
    				<span><a href="#"  style="color: white"><i style="color:#D69B25;font-size: 20px; " class=" fa fa-phone"></i>+964 751 786 3790</a></span><br><br>
    					...
    					<span style="color: white"> <i style="color:#D69B25;font-size: 20px; " class=" fa fa-envelope"></i> info@Maalialkhir.IQ</span>
    					<br>
    					<br>
			...
			<li><a href="https://www.instagram.com/Maalialkhir.ae"  style="color: white"><i style="color:#D69B25;font-size: 28px; " class=" fab fa-instagram"></i> Citizenshipsae</a></li><br>
...
<div style="height: 40px;background-color:#10305a;padding-top: 6px; ">
	<p class="text-center text-warning">All Right Reserved To Maali al khir <i class="fa fa-heart"></i> 2021</p>
